  ...
  return (
    <footer className="footer">
      <div className="footer-left">
        <h2 className="titulo">RUBI PERFUMERÍA</h2>
        <p id="description-id" className="description">
          ¡Descubre la fragancia que te define con nuestra exclusiva colección
          de perfumes! Ofrecemos esencias únicas y sofisticadas para cada
          personalidad.
        </p>
